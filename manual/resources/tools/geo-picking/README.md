...
[the article on aligning HTML elements to 3D](https://www.252x.com/manual/en/align-html-elements-to-3d.html)
and [the article on using indexed textures for picking and color](https://www.252x.com/manual/en/indexed-textures.html)
